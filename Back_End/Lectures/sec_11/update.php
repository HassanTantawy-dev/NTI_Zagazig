...
<body>
    ...
    <?php endif; ?>
    <form method="post" action="handlecustomer.php?id=<?= $user["id"] ?>" class="w-75 m-auto">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="city" value="<?= $user["city"] ?>" id="exampleInputPassword1">
        </div>
        <div class="form-group">
